...
기술 스택: React 19, TypeScript, Vite, Bun, Vitest
...
- 커밋 메시지는 영어 명령형으로 작성하고 하나의 커밋에는 하나의 목적만 담는다.
- 기능과 실행 방법은 [README.md](./README.md)를 참고한다.
- 브라우저 검증 절차와 출력 형식은
  [browser-verifier.md](./.claude/agents/browser-verifier.md)를 따른다.
